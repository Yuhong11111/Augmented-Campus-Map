...
namespace ARLocation.MapboxRoutes.SampleProject
{
    ...
    public class ArMenuController : MonoBehaviour
    {
        ...
        public class ElementsData
        {
            ...
            public RectTransform TargetUpload;
        ...
        void showOnlyToggleButton()
        {
            ...
            Elements.BtnUpload.gameObject.SetActive(false);
        }
        ...
        void showAllButtons()
        {
            ...
            Elements.BtnToggle.gameObject.SetActive(true);
            Elements.BtnUpload.gameObject.SetActive(true);
        }
        ...
        void openMenu()
        {
            switch (s.CurrentState)
            {
                case StateType.Closed:
                    ...
                    s.tweenGroup.Elements.Add(new TweenRectTransform(Elements.BtnUpload.GetComponent<RectTransform>(), Elements.TargetUpload.position, Quaternion.identity));
        ...
        void closeMenu()
        {
            switch (s.CurrentState)
            {
                case StateType.Open:
                    ...
                    s.tweenGroup.Elements.Add(new TweenRectTransform(Elements.BtnUpload.GetComponent<RectTransform>(), togglerRt.position, Quaternion.identity));
        ...
        void showButtonLabels()
        {
            ...
            Elements.LabelUpload.gameObject.SetActive(true);
        }
        ...
        void hideButtonLabels()
        {
            ...
            Elements.LabelUpload.gameObject.SetActive(false);
